...
export class CalendarEventComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.calendarEventService
      ...
      .subscribe({
        next: (res: HttpResponse<ICalendarEvent[]>) => {
  ...
  trackId(_index: number, item: ICalendarEvent): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICalendarEvent[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
