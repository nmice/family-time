...
class FamilyResourceIT {
    ...
    void createFamily() throws Exception {
        ...
        restFamilyMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(family))
            )
    ...
    void putWithMissingIdPathParamFamily() throws Exception {
        ...
        restFamilyMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(family))
            )
    ...
    void deleteFamily() throws Exception {
        ...
        // Delete the family
        restFamilyMockMvc
            .perform(delete(ENTITY_API_URL_ID, family.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
